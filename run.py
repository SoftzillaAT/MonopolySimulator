...
def run_simulation(player1_type, player2_type, num_games, start_seed, model_path=None):
    ...
    for seed in range(start_seed, start_seed + num_games):
        ...
        p1 = make_player(player1_type, 'spieler1', 1, bank, list_board, dict_roads,
                         dict_properties, community_deck, chance_deck, model_path)
        p2 = make_player(player2_type, 'spieler2', 2, bank, list_board, dict_roads,
                         dict_properties, community_deck, chance_deck, model_path)
...
def main():
    ...
    wins = run_simulation(args.spieler1, args.spieler2, args.spiele, args.seed, args.modell)
